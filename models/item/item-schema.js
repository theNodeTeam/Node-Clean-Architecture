...
module.exports = Joi.object().keys({
  ...
  isFeatured: Joi.boolean().optional().error(() => 'isFeatured must be a boolean'),
  isOutOfStock: Joi.boolean().optional().error(() => 'isOutOfStock must be a boolean'),
  ...
  quantity: Joi.string().optional().error(() => 'quantity must be a string'),
